...
<head>
    ...
    <link rel="stylesheet" href="agregartienda-style.css">
...
<body class="cuerpolocaltienda">
    ...
    <main class="main_principaltienda">
        <div class="contenedor_whitetienda">
            ...
            <div class="texto_localidad1tienda">
                    <input type="text1" class="inicio_type1" id= "i_tienda1" placeholder="Ingresar nombre de la tienda *" required><!--campo obligatorio-->            
            </div> 
            ...
            <div class="texto_localidad1tienda">
                    <input type="text1" class="inicio_type2" id= "i_tienda2" placeholder="Descripción">           
            </div> 
                <br>
            
            <!--TERCER INPUT INGRESAR DIRECCION-->
            <div class="texto_localidad1tienda">
                <input type="text1" class="inicio_type3" id= "i_tienda3" placeholder="Ingresar Dirección">            
            </div> 
            
            <!--CUARTO INPUT INGRESAR TELEFONO-->
            <div class="texto_localidad4">
                <input type="text1" class="inicio_type3" id= "i_tienda4" placeholder="Ingresar teléfono">            
            </div> 

            <!--QUINTO INPUT INGRESAR LINK IMAGEN-->
            <div class="texto_localidad4">
                <input type="text1" class="inicio_type3" id= "i_tienda5" placeholder="Ingresar enlace de imagen de la tienda">            
            </div> 
                        
                <br>

            <!--PRIMER BOTON ENVIO FORMULARIO-->
            <div class="boton1tienda" style="text-align: center; justify-content: center; display: flex; width: 100%;">
            ...
            <form  action="javascript:alert('Datos de producto agregados');" class="form_tienda2">
                ...
                <div class="nombre_producto">
                    <input type="producto1" class="n_producto1" id= "ptienda1" placeholder="Nombre producto *" required><!--campo obligatorio-->            
                </div> 

                <div class="precio">
                    <input type="producto1" class="n_producto1" id= "ptienda2" placeholder="Precio *" required><!--campo obligatorio-->            
                </div> 

                <div class="imagen_producto">
                    <input type="producto1" class="n_producto1" id= "ptienda3" placeholder="Ingrese enlace de la imagen del producto" required><!--campo obligatorio-->            
                </div> 

                <br>

                <!--SEGUNDO BOTON ENVIO FORMULARIO-->
                <div class="boton2tienda" style="text-align: center; justify-content: center; display: flex; width: 100%;">
