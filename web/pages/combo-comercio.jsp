...
<body class="cuerpo">
    ...
    <main>
        ...
        <div class="body-container">
            <div class="search">
                <input type="text" class="buscar_texto" placeholder="¿Que combo te conviene mas?">
                <a href="#" class="boton">
                    <i class="icon-buscar"></i>
                </a>
            </div>

            <h4 class="subtitulo">Combos Existentes</h4>
            ...
            <div class="body-cards">
                ...
                <div class="body-card-item">
                    ...
                    <div class="card-score">
                        <div class="fav">
                            <a class="favo" type="checkbox" href="#">
                ...
                <div class="boton1addtrans" style="text-align: center; justify-content: center; display: flex; width: 100%;">
                    <button class="button-add" type="submit" value="Submit" name="agregar_tienda"
                        style="background-color: rgb(160, 213, 158); border-radius: 8px;">
                        <b>Agregar Combo</b>
